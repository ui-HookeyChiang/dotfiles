...
**Exploitability principle:** Only report what you can exploit. Every finding
needs a concrete attack scenario (≤2 sentences). "An attacker could
theoretically..." is not a finding — it's speculation. If you cannot determine
reachability from the PR diff alone, downgrade to MED and note "reachability
unconfirmed from diff context".
