"""Structural integrity test for the behavior_mismatch_unbuilt fixture set.
...
FIXTURES_DIR = Path(__file__).parent / "fixtures" / "behavior_mismatch_unbuilt"

EXPECTED_FILES = {
    "positive_flow_enhancement_blockquote.md",
    "positive_doc_only_deferred.md",
    "positive_future_phase_sentence.md",
    "negative_live_wip_with_backing_code.md",
    "negative_shipped_feature_description.md",
}
