...
local plug_map = {
    ...
    ["n|gc"]             = map_cmd("<cmd>lua vim.lsp.buf.references()<CR>"):with_noremap():with_silent(),
    ...
    ["n|gf"]             = map_cmd("<cmd>lua vim.lsp.buf.format()<CR>"):with_noremap():with_silent(),
    ...
    ["n|<Leader>/"]      = map_cu('Telescope current_buffer_fuzzy_find'):with_noremap():with_silent(),
