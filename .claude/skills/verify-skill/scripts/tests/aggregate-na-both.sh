#!/usr/bin/env bash
# SC11 — voting_total==3 → APPROVE_WITH_NOTES (NOT INSUFFICIENT_BALLOTS).
# This is the prototype regression case.
set -euo pipefail
...
assert r['voting_total'] == 3
assert r['na_count'] == 2
print('PASS: aggregate-na-both')
"
